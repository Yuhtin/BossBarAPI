    ...
    protected void updateDataWatcher() {
        if (this.dataWatcher == null) {
            try {
                ...
                DataWatcher.setValue(this.dataWatcher, 17, ENTITY_WITHER_a, 0);
                DataWatcher.setValue(this.dataWatcher, 18, ENTITY_WIHER_b, 0);
                DataWatcher.setValue(this.dataWatcher, 19, ENTITY_WITHER_c, 0);

                DataWatcher.setValue(this.dataWatcher, 20, ENTITY_WITHER_bw, 1000);// Invulnerable time (1000 = very small)
                DataWatcher.setValue(this.dataWatcher, 0, ENTITY_FLAG, (byte) (1 << 5));
            } catch (Exception e) {
